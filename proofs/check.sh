...
cat OrderInvariance.lean RoundNearestEven.lean FloatGCounter.lean ToolkitAlgebra.lean > "$TMP"
cat >> "$TMP" <<'AX'
...
echo "OK: order-invariance + rounding kernel + G-Counter + toolkit merge algebra proved; axioms = standard base only"
